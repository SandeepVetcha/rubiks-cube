...
//    vector<RubiksCube::Move> shuffle_moves = cube.randomShuffleCube(13);
//    //for (auto move: shuffle_moves) cout << cube.getMove(move) << " ";
//    cout << "\n";
//    cube.print();

//    IDAstarSolver<RubiksCubeBitboard, HashBitboard> idAstarSolver(cube, "my_data.txt");
...
//    Code to create Corner Database
    // CornerDBMaker dbMaker("new.txt", 0x99);
    // dbMaker.bfsAndStore();
