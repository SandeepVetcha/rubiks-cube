...
class RubiksCube1dArray : public RubiksCube
{
    private:
        /*
         * Returning the modified index of a 1D array 
         * representation for a given face, row and col
        */
        ...
        RubiksCube1dArray()
        {
            for(int i=0;i<6;i++)
            {
                for(int j=0;j<3;j++)
                {
                    for(int k=0;k<3;k++)
                    {
                        cube[i*6 + j*3 + k] = getColorLetter(Color(i));
                    }
                }
            }
        }
        ...
        bool isSolved() const override
        {
            for(int i=0;i<6;i++)
            {
                for(int j=0;j<3;j++)
                {
                    for(int k=0;k<3;k++)
                    {
                        if(cube[i*9 + j*3 + k] != getColorLetter(Color(i))) return false;
                    }
                }
            }
